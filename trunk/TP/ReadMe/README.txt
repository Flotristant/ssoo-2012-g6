...
5- Abrir una terminal, pararse dentro del directorio "grupo06" y darle permiso de ejecución al script "instalarU.sh" que se encuentra en el mismo utilizando el siguiente comando:
> chmod +x ./InstalarU.sh

6- Moverse al directorio "grupo06".
